  ...
  _createClass(FooterActions, [{
    ...
    value: function getFiveRecentMovies() {
      ...
      $.ajax(request).done(function (data) {
        return _this.getFiveRecentMoviesSuccess;
      }).fail(function (err) {
...
var Footer = function (_React$Component) {
  ...
  _createClass(Footer, [{
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _FooterActions2.default.unlisten(this.onChange);
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      _HomeAction2.default.getTopTenMovies();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
    ...
    value: function render() {
      var movies = this.state.topTenMovies.map(function (movie, index) {
        return _react2.default.createElement(_MovieCard2.default, {
          key: movie._id,
          movie: movie,
          index: index });
      });
...
},{"../actions/HomeAction":34,"../stores/HomeStore":60,"./sub-components/MovieCard":45,"react":"react"}],42:[function(require,module,exports){
'use strict';
...
var _MovieAddStores = require('../stores/MovieAddStores');

var _MovieAddStores2 = _interopRequireDefault(_MovieAddStores);
...
var AddMovie = function (_React$Component) {
  ...
  function AddMovie(props) {
    ...
    _this.state = _MovieAddStores2.default.getState();
  ...
  _createClass(AddMovie, [{
    ...
    key: 'componentDidMount',
    value: function componentDidMount() {
      _MovieAddStores2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _MovieAddStores2.default.unlisten(this.onChange);
    }
  }, {
    key: 'handleSubmit',
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', {
                      type: 'text', className: 'form-control', ref: 'nameTextField',
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement('input', {
                        type: 'checkbox', name: 'genres', id: 'action', value: 'Action',
                    ...
                    _react2.default.createElement(
                      ...
                      { className: 'checkbox checkbox-inline' },
                      _react2.default.createElement('input', {
                        type: 'checkbox', name: 'genres', id: 'horror', value: 'Horror',
                    ...
                    _react2.default.createElement(
                      ...
                      { className: 'checkbox checkbox-inline' },
                      _react2.default.createElement('input', {
                        type: 'checkbox', name: 'genres', id: 'sci-fi', value: 'Sci-fi',
                    ...
                    _react2.default.createElement(
                      ...
                      { className: 'checkbox checkbox-inline' },
                      _react2.default.createElement('input', {
                        type: 'checkbox', name: 'genres', id: 'fantasy', value: 'Fantasy',
                    ...
                    _react2.default.createElement(
                      ...
                      { className: 'checkbox checkbox-inline' },
                      _react2.default.createElement('input', {
                        type: 'checkbox', name: 'genres', id: 'adventure', value: 'Adventure',
...
},{"../actions/MovieAddActions":35,"../stores/MovieAddStores":61,"react":"react"}],43:[function(require,module,exports){
'use strict';
...
var _UserProfileInfo = require('./sub-components/UserProfileInfo');
  ...
  _createClass(UserProfile, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_UserProfileInfo2.default, {
          name: this.state.name,
...
},{"../stores/UserStore":63,"./sub-components/UserProfileInfo":52,"./sub-components/UserRatedMovies":53,"./sub-components/UserReviews":55,"react":"react"}],45:[function(require,module,exports){
'use strict';
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_MoviePanelsToggle2.default, {
...
},{"./MovieCommentsPanel":46,"./MovieInfo":47,"./MoviePanelsToggle":48,"./MoviePoster":49,"./MovieVotePanel":50,"react":"react"}],46:[function(require,module,exports){
'use strict';
...
var MovieCommentsPanel = function (_Component) {
  _inherits(MovieCommentsPanel, _Component);
...
var MoviePanelToggles = function (_React$Component) {
  _inherits(MoviePanelToggles, _React$Component);
...
var MoviePoster = function (_React$Component) {
  ...
  function MoviePoster() {
    ...
    return _possibleConstructorReturn(this, (MoviePoster.__proto__ || Object.getPrototypeOf(MoviePoster)).apply(this, arguments));
  }
...
var UserProfileInfo = function (_Component) {
  ...
  function UserProfileInfo() {
    ...
    return _possibleConstructorReturn(this, (UserProfileInfo.__proto__ || Object.getPrototypeOf(UserProfileInfo)).apply(this, arguments));
  }
...
var UserRatedMovies = function (_React$Component) {
  _inherits(UserRatedMovies, _React$Component);

  function UserRatedMovies(props) {
    _classCallCheck(this, UserRatedMovies);

    var _this = _possibleConstructorReturn(this, (UserRatedMovies.__proto__ || Object.getPrototypeOf(UserRatedMovies)).call(this, props));

    _this.state = {
      showRatedMoviePanel: false
    };
    return _this;
  }

  _createClass(UserRatedMovies, [{
...
},{"./UserRatedMoviesPanel":54,"react":"react"}],54:[function(require,module,exports){
'use strict';
...
var UserVotedMoviesPanel = function (_React$Component) {
  ...
  function UserVotedMoviesPanel() {
    _classCallCheck(this, UserVotedMoviesPanel);

    return _possibleConstructorReturn(this, (UserVotedMoviesPanel.__proto__ || Object.getPrototypeOf(UserVotedMoviesPanel)).apply(this, arguments));
  }
...
var UserReviews = function (_Component) {
  _inherits(UserReviews, _Component);
...
},{"./UserReviewsPanel":56,"react":"react"}],56:[function(require,module,exports){
'use strict';
...
var UserReviewsPanel = function (_Component) {
  _inherits(UserReviewsPanel, _Component);

  function UserReviewsPanel() {
    _classCallCheck(this, UserReviewsPanel);

    return _possibleConstructorReturn(this, (UserReviewsPanel.__proto__ || Object.getPrototypeOf(UserReviewsPanel)).apply(this, arguments));
  }
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: '/user/profile/:userId', components: _UserProfile2.default })
);
...
var HomeStore = function () {
  function HomeStore() {
    ...
    this.bindActions(_HomeAction2.default);
...
},{"../actions/HomeAction":34,"../alt":38}],61:[function(require,module,exports){
'use strict';
...
var MovieAddStores = function () {
  function MovieAddStores() {
    _classCallCheck(this, MovieAddStores);
  ...
  return MovieAddStores;
}();

exports.default = _alt2.default.createStore(MovieAddStores);
...
var _MoviePanelsToggle = require('../components/sub-components/MoviePanelsToggle');

var _MoviePanelsToggle2 = _interopRequireDefault(_MoviePanelsToggle);

var _MoviePoster = require('../components/sub-components/MoviePoster');
...
var Helpers = function () {
  ...
  _createClass(Helpers, null, [{
    ...
    value: function nodesMovieCard(state, props, toggleCommentsPanel, toggleVotePanel) {
      ...
      nodes.panelToggle = _react2.default.createElement(_MoviePanelsToggle2.default, {
      ...
      nodes.poster = _react2.default.createElement(_MoviePoster2.default, { posterUrl: props.movie.moviePosterUrl });
...
},{"../components/sub-components/MovieCommentsPanel":46,"../components/sub-components/MoviePanelsToggle":48,"../components/sub-components/MoviePoster":49,"../components/sub-components/MovieVotePanel":50,"react":"react"}],65:[function(require,module,exports){
'use strict';
    ...
    value: function getMoviePoster(movieName) {
      return new Promise(function (resolve, reject) {
        ...
        $.ajax(request).done(function (response) {
          ...
          var posterPath = response.results[0].poster_path;
          if (posterPath === null) {
